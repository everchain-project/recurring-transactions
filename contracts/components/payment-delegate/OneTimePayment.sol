...
contract OneTimePayment is IPayment {
    ...
    address public executor;            // The executor is responsible for triggering the one time payment
    ...
    function () public {
        require(msg.sender == executor, "the msg.sender must be the executor");
